<template>
  <div 
    ...
    class="fixed bottom-6 right-6 z-50 flex flex-col overflow-hidden rounded-xl shadow-2xl border w-80 transform transition-all duration-300 animate-in fade-in slide-in-from-bottom-4"
    :class="{
      'bg-red-50 dark:bg-red-900/90 border-red-200 dark:border-red-800': type === 'error',
      'bg-emerald-50 dark:bg-emerald-900/90 border-emerald-200 dark:border-emerald-800': type === 'success',
      'bg-indigo-50 dark:bg-indigo-900/90 border-indigo-200 dark:border-indigo-800': type === 'info'
    }"
  >
    ...
    >
      <div class="flex-1 text-sm font-semibold pr-2">{{ message }}</div>
